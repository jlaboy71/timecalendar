...
class DepartmentService:
    ...
    @staticmethod
    def create_department(db: Session, name: str, manager_id: Optional[int] = None) -> Department:
        """
        ...
        Raises:
            ValueError: If department name already exists or manager_id is invalid
        """
    ...
    def update_department(
        ...
        """
        Update department name and/or manager.
        ...
        Raises:
            ValueError: If department not found, name conflicts, or manager_id is invalid
        """
